...
enums:
  ...
  disconnect_reason:
    ...
    1:
      ...
      doc: |
        The client's [`handshake::network_version`]
    ...
    7:
      ...
      doc: |
        The provided [`world::client_validation::session_key`] is incorrect.
    8:
      id: account_not_in_pending_list
      doc: |
        Server did not expect a [`world::client_validation`] at this time.
    9:
      id: character_not_found
      doc: |
        The provided [`world::character_login_request::char_id`]
